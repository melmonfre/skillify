// Updated SimuladoCard to accept PracticeResponseDTO
...
export function SimuladoCard({ simulado, onViewResults }: SimuladoCardProps) {
  // Default mock values if no simulado is provided
